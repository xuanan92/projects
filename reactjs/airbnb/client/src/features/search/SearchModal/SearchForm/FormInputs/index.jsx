...
const FormInputs = () => {
  ...
  useEffect(() => {
    if (selectedOption !== 0) {
      setInputRegion(database[selectedOption].name);
    }
    if (inputRegion === "") {
      setDisplay(false);
      setShowRegion(true);
  ...
  return (
    <div>
      <form className="flex relative items-center m-auto bg-gray-100 rounded-full w-[848px]">
        <label className="flex flex-col py-4 px-8 mt-1 bg-gray-100 rounded-full cursor-pointer focus-within:bg-white focus-within:border focus-within:border-gray-300 focus-within:shadow-2xl focus-within:scale-105 focus-within:shadow-gray-300">
          Where
          <input
            type="text"
